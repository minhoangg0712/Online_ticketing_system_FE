...
@Component({
  ...
  styleUrl: './workshop-event.component.css'
})
export class WorkshopEventComponent {
  events: any[] = [];
  visibleItems: any[] = [];
  startIndex: number = 0;
  ...
  loadWorkshopEvents() {
    this.eventService.getRecommendedEvents('Workshop').subscribe(res => {
